...
Use the [Core 0.1 canonical path index](docs/set-calculus-core/CORE_0.1_PATH_INDEX.md) to locate current Core artifacts and the required artifact paths that remain open. The index is navigational evidence only and does not change checklist ownership or pass/fail state.
